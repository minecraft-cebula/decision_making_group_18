# -*- coding: utf-8 -*-
"""
HVAC Daily MILP Optimization
==============================
Solves one MILP per day for each of the 100 days in the dataset.
Reports the average daily electricity cost.

Each day is fully independent — no scenario coupling.
The plot shows results for a representative day (default: day 0).
"""
...
# =============================================================================
# LOAD DATA  (100 rows x 10 timeslots)
# =============================================================================
...
def solve_day(day_idx, occ1, occ2, price, verbose=False):
    ...
    # -------------------------------------------------------------------------
    # Helper: previous-step values (use initial conditions at t=0)
    # -------------------------------------------------------------------------
